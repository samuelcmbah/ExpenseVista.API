...
using ExpenseVista.API.Services.Auth;
using ExpenseVista.API.Services.Background;
using ExpenseVista.API.Services.Exports;
...
builder.Services.AddScoped<IFinancialReportExporter, FinancialReportExcelExporter>();
