...
namespace ExpenseVista.API.Migrations
{
    ...
    [Migration("20251118212125_IsAutomaticColumnTransaction")]
    partial class IsAutomaticColumnTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseVista.API.Models.Budget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseVista.API.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseVista.API.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseVista.API.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("ExpenseVista.API.Models.Category", "Category")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("ExpenseVista.API.Models.WalletTransaction", b =>
                {
                    b.HasOne("ExpenseVista.API.Models.Wallet", "Wallet")
                        .WithMany("Transactions")
